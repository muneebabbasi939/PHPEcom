        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header bg-primary">
                    ...
                    <a href="orders.php" class="btn btn-warning float-end"><i class="fa fa-reply"></i>
                        Back</a>
                </div>
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                <form action="code.php" method="POST">
                                    ...
                                    <button type="submit" name="updateOrderBtn" class="btn btn-primary mt-2">Update Status</button>
                                </form>
                            </div>
                        </div>
                    </div>
