...
<section class="vh-100 bg" id="login-img">
    <?php
                ...
                <div class="card" style="border-radius: 1rem;">
                    <div class="row g-0">
                        <div class="col-md-6 col-lg-5 d-flex">
                            <img src="assets/img/PHPx.png" alt="login form" class="img-fluid"
                            ...
                            <div class="card-body text-white p-4 p-lg-5 ">
                                ...
                                <form action="functions/authcode.php" method="POST">
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <h2 class="fw-bold mb-3 pb-3" style="letter-spacing: 1px;">Sign into your
                                            account</h2>
                                    </div>
                                    ...
                                    <div class="pt-1 mb-4">
                                        <button type="submit" name="login_btn" class="btn text-white">Login</button>
